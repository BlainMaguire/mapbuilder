...
function makeTextArea() {
    ...
    textarea.value = "Click save to save your work as text here! Direction keys move around map. WASD change current tile. Space places tiles. Enter acts like a dropper and changes the tile your using to wherever you're currently at. You can use the mouse as well. The load button will take a valid map in text format and display it above. Tested in Firefox.";
